...
int main(void) {
  ...
  // Another germ will be used during the correction
  // No polynomial of degree greater than 7 will be tested, because there is a risk of integer overflow.

  test_statistique(7, 1000, 123, test_generique_division);

  // Another germ will be used during the correction
  // No polynomial of degree greater than 4 will be tested, because there is a risk of integer overflow.
